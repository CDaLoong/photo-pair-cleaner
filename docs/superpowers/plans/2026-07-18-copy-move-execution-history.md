...
**Tech Stack:** Rust 2024, Tauri 2 commands/state, serde JSON manifests, SHA-256 streaming verification, React 19, TypeScript, Node test runner, CSS.
...
- [x] **Step 3: Implement the authorization boundary**
...
- [x] **Step 3: Implement the history store**
...
- [x] **Step 1: Write failing copy transaction tests**
...
- [x] **Step 3: Implement preflight and copy transaction**
...
- [x] **Step 1: Write failing move tests**
...
- [x] **Step 3: Implement move transactions**
...
- [x] **Step 1: Write failing sync and recovery tests**
...
- [x] **Step 3: Expose a trusted metadata write helper and implement recovery**
...
- [x] **Step 3: Implement commands and state locking**
...
- [x] **Step 3: Implement the execution workflow**
...
- [x] **Step 4: Implement results and history recovery UI**
...
- [x] **Step 1: Document the shipped safety model**
...
- [x] **Step 2: Run formatting and all automated checks**
...
- [x] **Step 3: Run desktop smoke testing with temporary copy/move directories**
